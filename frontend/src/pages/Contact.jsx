            ...
            <div className="w-full md:w-1/2 md:pl-4">
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-2">
                  ...
                  <span>+91 7631699493</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaEnvelope className="text-pink-500" />
                  <span>sumitkrsahu7@gmail.com</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaMapMarkerAlt className="text-green-500" />
                  <span>Permanent: Pandaul, Madhubani, Bihar, 847234 </span>
                  <span>Current: Madhuravoyal, Chennai, Tamil Nadu, 600095</span>
                </li>
              </ul>
            </div>
          </div>
